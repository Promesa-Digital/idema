...
import { FiBookOpen, FiCheckSquare, FiUser } from 'react-icons/fi'
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            {user?.role === 'alumno' && (
              <>
                ...
                >
                  <FiBookOpen aria-hidden /> Mis matrículas
                </Link>
                <Link
                  to="/portal/mis-electivos"
                  className="inline-flex items-center gap-2 px-6 py-3 text-white font-bold rounded-lg border border-white/20 bg-white/5 hover:bg-white/10 transition-all duration-300"
                >
                  <FiCheckSquare aria-hidden /> Mis electivos
                </Link>
              </>
            )}
          </div>
